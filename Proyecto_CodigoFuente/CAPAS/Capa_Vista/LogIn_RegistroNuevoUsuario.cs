...
{
    public partial class LogIn_RegistroNuevoUsuario : Form
    {
        ...
        private void pnlCuentaEmpresa_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
        ...
        private void pnlCuentaRepartidor_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
        ...
        private void pnlCuentaUsuario_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
        ...
        #region REGISTRO USUARIO NORMAL
        //VENTANA FORM
        ...
        private void btnRegistrar_Usuario_Click(object sender, EventArgs e)
        {
                    ...
                    try
            {
                        ...
                        if (!txtNumeroTelefono_Usuario.MaskFull)
                        {
                ...
                try
            {
                ...
                log.Info("SE REGISTRO EXITOSAMENTE EL USUARIO : "+user.Nombre);
        ...
        #region REGISTRO USUARIO EMPRESA
        //VENTANA FORM
        ...
        #region REGISTRO USUARIO REPARTIDOR
        //VENTANA FORM
            ...
            try
            {
                //Validcaciones generales
                    try
                    {
                        ...
                        if (!txtTelefono_Repartidor.MaskFull)
                        {
