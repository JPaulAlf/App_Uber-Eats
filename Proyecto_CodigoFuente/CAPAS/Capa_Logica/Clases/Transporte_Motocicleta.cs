...
{
    /// <summary>
    /// Clase Transporte_Motocicleta, hereda metodos y propiedades de Transporte y de ITransporte
    /// </summary>
    public class Transporte_Motocicleta : Transporte,ITransporte
    {
        #region PROPIEDADES
        /// <summary>
        /// NumeroPlaca
        ...
        /// </summary>
        public Transporte_Motocicleta() : base()
        {
            this.NumeroPlaca = 0;
        ...
        /// </summary>
        public Transporte_Motocicleta(string pMarca, string pModelo, string pColor, int pNumeroPlaca, bool pEstaAsegurado)
